...
### Best Practices for Context and Instruction Files
...
### Preferring Shell/Bash Commands Over Tools
...
### Using Parallel or Subagents for Long Tasks

1. Use input and output files to/from agents.
2. Apply all above practices to subagents.

### Managing Summarization and Handover to Next Agent
...
### Favoring Progressive or Conditional Context Loading
